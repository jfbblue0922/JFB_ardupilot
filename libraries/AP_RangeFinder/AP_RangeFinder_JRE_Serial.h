...
|      |  (1)   |  (2)   |          |  count   |    (H)   |    (L)   |               |    (H)    |    (L)    |    (H)   |    (L)   |               |    (H)    |    (L)    |    (H)   |    (L)   |               |    (H)    |    (L)    |    (H)    |    (L)    |  (L)  |  (H)  |
|------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|      |        |        |          |          |                     |               |                       |                     |               |                       |                     |               |                       | BIT 15to8: reserved   |               |
...
|      |  (1)   |  (2)   |          |  count   |    (H)   |    (L)   |               |    (H)    |    (L)    |    (H)   |    (L)   |               |    (H)    |    (L)    |    (H)   |    (L)   |               |    (H)    |    (L)    |    (H)   |    (L)   |               |    (H)    |    (L)    |    (H)   |    (L)   |               |    (H)    |    (L)    |    (H)    |    (L)    |  (L)  |  (H)  |
|------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|      |        |        |          |          |                     |               |                       |                     |               |                       |                     |               |                       |                     |               |                       |                     |               |                       | BIT 15to8: reserved   |               |
...
[4]
Measurement mode: 1 data mode (Extension)
Packet length: 30 bytes
Altitude data used: 11,12 bytes
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| BYTE |   0    |   1    |   2    |   3    |   4 ~ 7    |    8     |    9     |    10    |    11    |    12    |  13 ~ 18   |    19     |    20     |  21 ~ 22   |         23           |  24 ~ 27   |  28   |  29   |
|------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| NAME | header | header | header | header |  reserved  |   S/W    |   S/W    |  frame   | altitude | altitude |  reserved  | FFT value | FFT value |  reserved  |       status         |  reserved  |  CRC  |  CRC  |
|      |  (1)   |  (2)   |  (3)   |  (4)   |            | version  | version  |  count   |    (H)   |    (L)   |            |    (H)    |    (L)    |            |                      |            |  (L)  |  (H)  |
|      |        |        |        |        |            | (major)  | (minor)  |          |          |          |            |           |           |            |                      |            |       |       |
|------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|      |        |        |        |        |            |          |          |          |                     |            |                       |            |        Low/High      |            |               |
|      |        |        |        |        |            |          |          | unsigned |       unsigned      |            |       unsigned        |            | BIT 3: Success/Fail  |            |   CRC result  |
| DATA |  'R'   |  'X'   |  'A'   |  'A'   |    N/A     | 0 to 255 | 0 to 255 | 0 to 255 |      LSB:0.01 m     |    N/A     |        LSB:1          |    N/A     | BIT 2: reserved      |    N/A     |   from BYTE   |
|      |        |        |        |        |            |          |          |          |      0 to 65535     |            |      0 to 65535       |            | BIT 1: TRK/NTRK      |            |    0 to 27    |
|      |        |        |        |        |            |          |          |          |                     |            |                       |            | BIT 0: GAIN LOW/HIGH |            |               |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

[5]
Measurement mode: 3 data mode (Extension)
Packet length: 50 bytes
Altitude data used: 11,12 bytes
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| BYTE |   0    |   1    |   2    |   3    |   4 ~ 7    |    8     |    9     |    10    |    11    |    12    |  13 ~ 18   |    19     |    20     |    21    |    22    |  23 ~ 28   |    29     |    30     |    31    |    32    |  33 ~ 38   |    39     |    40     |  41 ~ 42   |         43           |  44 ~ 47   |  48   |  49   |
|------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| NAME | header | header | header | header |  reserved  |   S/W    |   S/W    |  frame   | altitude | altitude |  reserved  | FFT value | FFT value | altitude | altitude |  reserved  | FFT value | FFT value | altitude | altitude |  reserved  | FFT value | FFT value |  reserved  |       status         |  reserved  |  CRC  |  CRC  |
|      |  (1)   |  (2)   |  (3)   |  (4)   |            | version  | version  |  count   |    (H)   |    (L)   |            |    (H)    |    (L)    |    (H)   |    (L)   |            |    (H)    |    (L)    |    (H)   |    (L)   |            |    (H)    |    (L)    |            |                      |            |  (L)  |  (H)  |
|      |        |        |        |        |            | (major)  | (minor)  |          |          |          |            |           |           |          |          |            |           |           |          |          |            |           |           |            |                      |            |       |       |
|------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|      |        |        |        |        |            |          |          |          |                     |            |                       |                     |            |                       |                     |            |                       |            |        Low/High      |            |               |
|      |        |        |        |        |            |          |          | unsigned |       unsigned      |            |       unsigned        |       unsigned      |            |       unsigned        |       unsigned      |            |       unsigned        |            | BIT 3: Success/Fail  |            |   CRC result  |
| DATA |  'R'   |  'X'   |  'A'   |  'B'   |    N/A     | 0 to 255 | 0 to 255 | 0 to 255 |      LSB:0.01 m     |    N/A     |        LSB:1          |      LSB:0.01 m     |    N/A     |        LSB:1          |      LSB:0.01 m     |    N/A     |        LSB:1          |    N/A     | BIT 2: reserved      |    N/A     |   from BYTE   |
|      |        |        |        |        |            |          |          |          |      0 to 65535     |            |      0 to 65535       |      0 to 65535     |            |      0 to 65535       |      0 to 65535     |            |      0 to 65535       |            | BIT 1: TRK/NTRK      |            |    0 to 27    |
|      |        |        |        |        |            |          |          |          |                     |            |                       |                     |            |                       |                     |            |                       |            | BIT 0: GAIN LOW/HIGH |            |               |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

[6]
Measurement mode: 5 data mode (Extension)
Packet length: 70 bytes
Altitude data used: 11,12 bytes
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| BYTE |   0    |   1    |   2    |   3    |   4 ~ 7    |    8     |    9     |    10    |    11    |    12    |  13 ~ 18   |    19     |    20     |    21    |    22    |  23 ~ 28   |    29     |    30     |    31    |    32    |  33 ~ 38   |    39     |    40     |    41    |    42    |  43 ~ 48   |    49     |    50     |    51    |    52    |  53 ~ 58   |    59     |    60     |  61 ~ 62   |         63           |  64 ~ 67   |  68   |  69   |
|------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| NAME | header | header | header | header |  reserved  |   S/W    |   S/W    |  frame   | altitude | altitude |  reserved  | FFT value | FFT value | altitude | altitude |  reserved  | FFT value | FFT value | altitude | altitude |  reserved  | FFT value | FFT value | altitude | altitude |  reserved  | FFT value | FFT value | altitude | altitude |  reserved  | FFT value | FFT value |  reserved  |       status         |  reserved  |  CRC  |  CRC  |
|      |  (1)   |  (2)   |  (3)   |  (4)   |            | version  | version  |  count   |    (H)   |    (L)   |            |    (H)    |    (L)    |    (H)   |    (L)   |            |    (H)    |    (L)    |    (H)   |    (L)   |            |    (H)    |    (L)    |    (H)   |    (L)   |            |    (H)    |    (L)    |    (H)   |    (L)   |            |    (H)    |    (L)    |            |                      |            |  (L)  |  (H)  |
|      |        |        |        |        |            | (major)  | (minor)  |          |          |          |            |           |           |          |          |            |           |           |          |          |            |           |           |          |          |            |           |           |          |          |            |           |           |            |                      |            |       |       |
|------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|      |        |        |        |        |            |          |          |          |                     |            |                       |                     |            |                       |                     |            |                       |                     |            |                       |                     |            |                       |            |        Low/High      |            |               |
|      |        |        |        |        |            |          |          | unsigned |       unsigned      |            |       unsigned        |       unsigned      |            |       unsigned        |       unsigned      |            |       unsigned        |       unsigned      |            |       unsigned        |       unsigned      |            |       unsigned        |            | BIT 3: Success/Fail  |            |   CRC result  |
| DATA |  'R'   |  'X'   |  'A'   |  'C'   |    N/A     | 0 to 255 | 0 to 255 | 0 to 255 |      LSB:0.01 m     |    N/A     |        LSB:1          |      LSB:0.01 m     |    N/A     |        LSB:1          |      LSB:0.01 m     |    N/A     |        LSB:1          |      LSB:0.01 m     |    N/A     |        LSB:1          |      LSB:0.01 m     |    N/A     |        LSB:1          |    N/A     | BIT 2: reserved      |    N/A     |   from BYTE   |
|      |        |        |        |        |            |          |          |          |      0 to 65535     |            |      0 to 65535       |      0 to 65535     |            |      0 to 65535       |      0 to 65535     |            |      0 to 65535       |      0 to 65535     |            |      0 to 65535       |      0 to 65535     |            |      0 to 65535       |            | BIT 1: TRK/NTRK      |            |    0 to 27    |
|      |        |        |        |        |            |          |          |          |                     |            |                       |                     |            |                       |                     |            |                       |                     |            |                       |                     |            |                       |            | BIT 0: GAIN LOW/HIGH |            |               |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
private:
    ...
    uint8_t data_buff[70 * 3];  // 70 is longest possible packet
