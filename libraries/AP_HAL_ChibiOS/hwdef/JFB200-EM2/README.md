# JFB-200-EM2 Flight Controller

The JFB-200-EM2 flight controller is sold by [JAE](https://www.jae.com/Motion_Sensor_Control/eVTOL/FlightController/)

## Features

 - STM32H755 microcontroller
 - Three IMUs: ICM45686, ICM42688 and ASM330 SPI IMU
...
The JFB-200-EM2 supports up to 16 PWM outputs. 
...
The JFB-200-EM2 has a builtin two IST8310 compasses. Due to potential
...
To use them you need to limit the number of these pins that is used for
PWM by setting the BRD_PWM_COUNT to a number less than 8. For example
if you set BRD_PWM_COUNT to 14 then PWM15 and PWM16 will be available for
use as GPIOs.
...
The JFB-200-EM2 has 9 analog inputs
 - ADC  Pin0  -> not used
 - ADC  Pin1  -> not used
...
The JFB-200-EM2 has 4 I2C interfaces.
...
The JFB-200-EM2 has two independent CAN buses, with the following pinouts.

## Debug

The JFB-200-EM2 supports SWD debugging on the debug port
