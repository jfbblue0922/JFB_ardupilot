...
#define ASM330LHH_DEBUG 0

class AP_InertialSensor_ASM330LHH : public AP_InertialSensor_Backend
{
public:
    virtual ~AP_InertialSensor_ASM330LHH() { }
...
private:
    AP_InertialSensor_ASM330LHH(AP_InertialSensor &imu,
                              AP_HAL::OwnPtr<AP_HAL::Device> dev,
                              enum Rotation rotation);
